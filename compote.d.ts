...
/** CSS */
export declare function getAnimationDuration($el: HTMLElement): number;
/** HTML */
export declare const a: (properties?: {
    key?: string | number;
    oninit?(node?: Mithril.VirtualElement & {
        dom: HTMLElement;
    }): void;
    oncreate?(node?: Mithril.VirtualElement & {
        dom: HTMLElement;
    }): void;
    onbeforeupdate?(newNode?: Mithril.VirtualElement & {
        dom: HTMLElement;
    }, oldNode?: Mithril.VirtualElement & {
        dom: HTMLElement;
    }): boolean | void;
    onupdate?(node?: Mithril.VirtualElement & {
        dom: HTMLElement;
    }): void;
    onbeforeremove?(node?: Mithril.VirtualElement & {
        dom: HTMLElement;
    }): void | Promise<any>;
    onremove?(node?: Mithril.VirtualElement & {
        dom: HTMLElement;
    }): void;
